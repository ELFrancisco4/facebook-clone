...
function AllFriendsComponent() {
    return (
        <svg className={styles.navSvg} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
             viewBox="0 0 57 57" space="preserve"> 
        <g>           
...
export default AllFriendsComponent
