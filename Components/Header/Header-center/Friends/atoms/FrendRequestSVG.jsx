...
function FrendRequestSVG({svgClass}) {
  return  <svg className={svgClass} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
export default FrendRequestSVG;
